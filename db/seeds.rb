...
user1 = User.create(user_type: 'doctor', email: 'doctor1@test.com', password: '123456789')
DoctorProfile.create(user_id: user1.id, title: 'Dr', first_name: 'Johnny', last_name: 'Smith')

user2 = User.create(user_type: 'doctor', email: 'doctor2@test.com', password: '123456789')
DoctorProfile.create(user_id: user2.id,title: 'Dr', first_name: 'Anne', last_name: 'Jones')

user3 = User.create(user_type: 'doctor', email: 'doctor3@test.com', password: '123456789')
DoctorProfile.create(user_id: user3.id,title: 'Dr', first_name: 'Amy', last_name: 'Smithers')

user4 = User.create(user_type: 'doctor', email: 'doctor4@test.com', password: '123456789')
